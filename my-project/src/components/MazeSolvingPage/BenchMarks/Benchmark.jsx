...
const MazeBenchmarks = ({ mazeData, mazeGeneration }) => {
  ...
  const runtimeOptions = {
    ...
    plugins: {
      legend: { 
        position: 'top',
        labels: { color: 'white' } // Sets legend text color
      },
      title: { 
        display: true, 
        text: 'Runtime Comparison (ms) Across Benchmark Runs',
        color: 'white' // Sets title text color
      },
      tooltip: {
        callbacks: {
    ...
    scales: {
      x: {
        ticks: { color: 'white' } // Sets x-axis tick color
      },
      y: {
        ticks: { 
          color: 'white', // Sets y-axis tick color
  ...
  const stepsOptions = {
    ...
    plugins: {
      ...
      title: { 
        display: true, 
        text: 'Steps Taken Across Benchmark Runs',
        color: 'white'
      },
    },
    scales: {
    ...
    <div className="py-16 px-8">
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 border border-gray-200 rounded">
          <h3 className="text-xl text-white mb-2">Runtime Comparison</h3>
          <p className="text-white-700">
            Compare the runtime of each algorithm across benchmark runs.
          </p>
          <div className="w-full h-64">
            {benchmarkRunning ? (
              <p className="text-center text-white-500">Running benchmarks...</p>
            ) : runtimeChartData ? (
        ...
        {/* Steps Taken Chart */}
        <div className="p-6 border border-gray-200 rounded">
          <h3 className="text-xl text-white mb-2">Steps Taken</h3>
          <p className="text-white-700">
